...
var CancelReserve = /** @class */function () {
  ...
  CancelReserve.prototype.cancel = function () {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (CancelReserve);
...
var LikeShop = /** @class */function () {
  function LikeShop(btnSelector) {
    this.likeButtons = btnSelector;
  }
  LikeShop.prototype.handleButtonClick = function (likeBtn) {
    return __awaiter(this, void 0, void 0, function () {
      var shopId, answer, currentUrl, newUrl, heartEl, isLiked, error_1, answer, error_2;
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            _a.trys.push([1, 3,, 4]);
            return [4 /*yield*/, axios__WEBPACK_IMPORTED_MODULE_0___default().post("/likes/".concat(shopId))];
          case 2:
            _a.sent();
            return [3 /*break*/, 4];
          case 3:
          ...
          case 5:
            ...
            if (!answer) return [3 /*break*/, 9];
            heartEl.classList.toggle("is-not-liked");
            heartEl.classList.toggle("is-liked");
            _a.label = 6;
          case 6:
            _a.trys.push([6, 8,, 9]);
            return [4 /*yield*/, axios__WEBPACK_IMPORTED_MODULE_0___default()["delete"]("/likes/".concat(shopId))];
          case 7:
            _a.sent();
            return [3 /*break*/, 9];
          case 8:
  ...
  LikeShop.prototype.init = function () {
    var _this = this;
        ...
        return __awaiter(_this, void 0, void 0, function () {
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                e.preventDefault();
                return [4 /*yield*/, this.handleButtonClick(likeBtn)];
              case 1:
                _a.sent();
                return [2 /*return*/];
            }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (LikeShop);
